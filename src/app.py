...
activities = {
    ...
    "Basketball Club": {
        "description": "Drop-in basketball, drills, and intramural games",
    ...
    "Debate Team": {
        "description": "Prepare for debates, practice public speaking and research skills",
...
def remove_participant(activity_name: str, email: str):
    ...
    Example: DELETE /activities/Chess%20Club/participants?email=student@x.edu
    """
    if activity_name not in activities:
        raise HTTPException(status_code=404, detail="Activity not found")
